...
#line 37 "grammar.tab.cc" // lalr1.cc:404
...
#line 51 "grammar.tab.cc" // lalr1.cc:412
// Unqualified %code blocks.
#line 20 "grammar.y" // lalr1.cc:413
...
#line 63 "grammar.tab.cc" // lalr1.cc:413
...
namespace yy {
#line 130 "grammar.tab.cc" // lalr1.cc:479
      ...
      try
        {
          switch (yyn)
            {
  case 2:
#line 49 "grammar.y" // lalr1.cc:859
    { driver->insert(yystack_[0].value.as< std::vector<std::vector<std::vector<int>>> > ()); }
#line 771 "grammar.tab.cc" // lalr1.cc:859
    break;

  case 3:
#line 52 "grammar.y" // lalr1.cc:859
...
#line 777 "grammar.tab.cc" // lalr1.cc:859
    break;

  case 4:
#line 53 "grammar.y" // lalr1.cc:859
    { yylhs.value.as< std::vector<std::vector<std::vector<int>>> > ().push_back(yystack_[1].value.as< std::vector<std::vector<int>> > ());          }
#line 783 "grammar.tab.cc" // lalr1.cc:859
    break;

  case 5:
#line 56 "grammar.y" // lalr1.cc:859
...
#line 789 "grammar.tab.cc" // lalr1.cc:859
    break;

  case 6:
#line 59 "grammar.y" // lalr1.cc:859
    { yylhs.value.as< std::vector<int> > ().push_back(yystack_[0].value.as< int > ()); }
#line 795 "grammar.tab.cc" // lalr1.cc:859
    break;

  case 7:
#line 60 "grammar.y" // lalr1.cc:859
    { 
...
#line 804 "grammar.tab.cc" // lalr1.cc:859
    break;

  case 8:
#line 64 "grammar.y" // lalr1.cc:859
    { 
                                yylhs.value.as< std::vector<int> > () = yystack_[2].value.as< std::vector<int> > (); 
...
#line 815 "grammar.tab.cc" // lalr1.cc:859
    break;


#line 819 "grammar.tab.cc" // lalr1.cc:859
            default:
              break;
            }
        }
...
#line 1141 "grammar.tab.cc" // lalr1.cc:1167
#line 72 "grammar.y" // lalr1.cc:1168
